      ...
      cpuStat.usagePercent(function (e, percent, seconds) {
        try {
          ...
          for (let i = 0; i < guilds.length; i++) {
            if (guilds[i].members.me.voice.channel)
              connectedchannelsamount += 1;
          }
          ...
          const botinfo = new EmbedBuilder()
            ...
            .addFields(
              ...
              {
                name: "📁 Users",
                value: `\`Total: ${client.users.cache.size} Users used my commands since last restart\``,
                inline: true,
              },
              {
                name: "📁 Servers",
              ...
              {
                name: "😀 Emojis",
                value: `\`${client.emojis.cache.size}\` Emojis`,
                inline: true,
              },
              {
                name: "😎 Stickers",
                value: `\`${client.stickers.size} Stickers\``,
                inline: true,
              },
              {
                name: "\u200b",
