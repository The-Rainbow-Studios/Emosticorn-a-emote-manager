                    ...
                    if (
                      ...
                      subcommand.addUserOption((op) =>
                        op
                          ...
                          .setAutocomplete(
                            option.User.autocomplete ? true : false
                          )
                      );
                    } else if (
                      option.Integer &&
                      ...
                      subcommand.addIntegerOption((op) =>
                        op
                          ...
                          .setAutocomplete(
                            option.Integer.autocomplete ? true : false
                          )
                      );
                    } else if (
                      option.String &&
                      ...
                      subcommand.addChannelOption((op) =>
                        op
                          ...
                          .setAutocomplete(
                            option.Channel.autocomplete ? true : false
                          )
                      );
                    } else if (
                      option.Role &&
                      ...
                      subcommand.addRoleOption((op) =>
                        op
                          ...
                          .setAutocomplete(
                            option.Role.autocomplete ? true : false
                          )
                      );
                    } else if (
              ...
              if (option.User && option.User.name && option.User.description) {
                Command.addUserOption((op) =>
                  op
                    ...
                    .setDescription(option.User.description)
                    .setRequired(option.User.required)
                    .setAutocomplete(option.User.autocomplete ? true : false)
                );
              } else if (
                option.Integer &&
                option.Integer.name &&
                ...
                Command.addIntegerOption((op) =>
                  op
                    ...
                    .setDescription(option.Integer.description)
                    .setRequired(option.Integer.required)
                    .setAutocomplete(option.Integer.autocomplete ? true : false)
                );
              } else if (
                option.String &&
                option.String.name &&
                ...
                Command.addChannelOption((op) =>
                  op
                    ...
                    .setDescription(option.Channel.description)
                    .setRequired(option.Channel.required)
                    .setAutocomplete(option.Channel.autocomplete ? true : false)
                );
              } else if (
                option.Role &&
                option.Role.name &&
                ...
                Command.addRoleOption((op) =>
                  op
                    ...
                    .setDescription(option.Role.description)
                    .setRequired(option.Role.required)
                    .setAutocomplete(option.Role.autocomplete ? true : false)
                );
              } else if (
                option.StringChoices &&
                option.StringChoices.name &&
